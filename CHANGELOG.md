...
- Optimized Item.GetBasicInfo a bit
- Added realMinLevel detection to tooltip scanning
- Updated item scaling detection to use linkLevel and upgradeLevel
- Renamed Item.effectiveLevel to Item.realLevel
- Updated item tooltip scanning to mostly only use one implementation
