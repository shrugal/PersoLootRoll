...
Self.GEAR_TOKENS = {
    ...
    -- T30: Amirdrassil, the Dream's Hope
    [207462] = Self.TYPE_CHEST,
    [207463] = Self.TYPE_CHEST,
    [207464] = Self.TYPE_CHEST,
    [207465] = Self.TYPE_CHEST,
    [207466] = Self.TYPE_HAND,
    [207467] = Self.TYPE_HAND,
    [207468] = Self.TYPE_HAND,
    [207469] = Self.TYPE_HAND,
    [207470] = Self.TYPE_HEAD,
    [207471] = Self.TYPE_HEAD,
    [207472] = Self.TYPE_HEAD,
    [207473] = Self.TYPE_HEAD,
    [207474] = Self.TYPE_LEGS,
    [207475] = Self.TYPE_LEGS,
    [207476] = Self.TYPE_LEGS,
    [207477] = Self.TYPE_LEGS,
    [207478] = Self.TYPE_SHOULDER,
    [207479] = Self.TYPE_SHOULDER,
    [207480] = Self.TYPE_SHOULDER,
    [207481] = Self.TYPE_SHOULDER,
    -- Dragonflight Awakened
    [217316] = Self.TYPE_CHEST,
    [217317] = Self.TYPE_CHEST,
    [217318] = Self.TYPE_CHEST,
    [217319] = Self.TYPE_CHEST,
    [217320] = Self.TYPE_HAND,
    [217321] = Self.TYPE_HAND,
    [217322] = Self.TYPE_HAND,
    [217323] = Self.TYPE_HAND,
    [217324] = Self.TYPE_HEAD,
    [217325] = Self.TYPE_HEAD,
    [217326] = Self.TYPE_HEAD,
    [217327] = Self.TYPE_HEAD,
    [217328] = Self.TYPE_LEGS,
    [217329] = Self.TYPE_LEGS,
    [217330] = Self.TYPE_LEGS,
    [217331] = Self.TYPE_LEGS,
    [217332] = Self.TYPE_SHOULDER,
    [217333] = Self.TYPE_SHOULDER,
    [217334] = Self.TYPE_SHOULDER,
    [217335] = Self.TYPE_SHOULDER,
    -- T30: Nerub-ar Palace
    ...
    [225620] = Self.TYPE_HAND,
    [225621] = Self.TYPE_HAND,
    [225622] = Self.TYPE_HEAD,
    [225623] = Self.TYPE_HEAD,
    [225624] = Self.TYPE_HEAD,
    [225625] = Self.TYPE_HEAD,
    [225626] = Self.TYPE_LEGS,
    [225627] = Self.TYPE_LEGS,
    [225628] = Self.TYPE_LEGS,
    [225629] = Self.TYPE_LEGS,
    ...
    -- T33: The Voidspire
    [249347] = Self.TYPE_CHEST,
    [249348] = Self.TYPE_CHEST,
    [249349] = Self.TYPE_CHEST,
    [249350] = Self.TYPE_CHEST,
    [249351] = Self.TYPE_HAND,
    [249352] = Self.TYPE_HAND,
    [249353] = Self.TYPE_HAND,
    [249354] = Self.TYPE_HAND,
    [249355] = Self.TYPE_HEAD,
    [249356] = Self.TYPE_HEAD,
    [249357] = Self.TYPE_HEAD,
    [249358] = Self.TYPE_HEAD,
    [249359] = Self.TYPE_LEGS,
    [249360] = Self.TYPE_LEGS,
    [249361] = Self.TYPE_LEGS,
    [249362] = Self.TYPE_LEGS,
    [249363] = Self.TYPE_SHOULDER,
    [249364] = Self.TYPE_SHOULDER,
    [249365] = Self.TYPE_SHOULDER,
    [249366] = Self.TYPE_SHOULDER,
    -- T34: The Venomous Abyss
    [270910] = Self.TYPE_HAND,
    [270911] = Self.TYPE_HAND,
    [270912] = Self.TYPE_HAND,
    [270913] = Self.TYPE_HAND,
    [270914] = Self.TYPE_HEAD,
    [270915] = Self.TYPE_HEAD,
    [270916] = Self.TYPE_HEAD,
    [270917] = Self.TYPE_HEAD,
    [270918] = Self.TYPE_LEGS,
    [270919] = Self.TYPE_LEGS,
    [270920] = Self.TYPE_LEGS,
    [270921] = Self.TYPE_LEGS,
    [270922] = Self.TYPE_SHOULDER,
    [270923] = Self.TYPE_SHOULDER,
    [270924] = Self.TYPE_SHOULDER,
    [270925] = Self.TYPE_SHOULDER,
    [270926] = Self.TYPE_CHEST,
    [270927] = Self.TYPE_CHEST,
    [270928] = Self.TYPE_CHEST,
    [270929] = Self.TYPE_CHEST,
}
...
Self.OMNI_TOKENS = {
  ...
  -- T30: Amirdrassil, the Dream's Hope
  [210947] = { Self.TYPE_SHOULDER, Self.TYPE_HAND, Self.TYPE_HEAD, Self.TYPE_CHEST, Self.TYPE_LEGS },
  -- Dragonflight Awakened
  ...
  -- T33: The Voidspire
  [249367] = { Self.TYPE_SHOULDER, Self.TYPE_HAND, Self.TYPE_HEAD, Self.TYPE_CHEST, Self.TYPE_LEGS },
  -- T34: The Venomous Abyss
  [270909] = { Self.TYPE_SHOULDER, Self.TYPE_HAND, Self.TYPE_HEAD, Self.TYPE_CHEST, Self.TYPE_LEGS },
}
...
Self.TRINKETS = {
    ...
    [019379] = 148, -- Neltharion's Tear
    [019395] = 148, -- Rejuvenating Gem
    [019406] = 227, -- Drake Fang Talisman
    ...
    [110001] = 148, -- Tovra's Lightning Repository
    [110002] = 148, -- Fleshrender's Meathook
    [110003] = 132, -- Ragewing's Firefang
    [110004] = 148, -- Coagulated Genesaur Blood
    ...
    [158368] = 132, -- Sethraliss' Defiled Relic
    [158374] = 194, -- Tiny Electromental in a Jar
    [158712] = 65,  -- Rezan's Gleaming Eye
    ...
    [188282] = 20,  -- Auslese's Light Channeler
    [188352] = 32,  -- Argussian Compass
    [188359] = 20,  -- Alembic of Infernal Power
    [188396] = 20,  -- Bangle of Endless Blessings
    [188415] = 32,  -- Essence of Gossamer
    [188478] = 195, -- Needle-Encrusted Scorpion
    [188490] = 194, -- Grace of the Herald
    [188514] = 148, -- Witching Hourglass
    ...
    [207165] = 194, -- Bandolier of Twisted Blades
    [207166] = 67,  -- Cataclysmic Signet Brand
    [207169] = 97,  -- Branch of the Tormented Ancient
    [207170] = 20,  -- Smoldering Seedling
    [207171] = 20,  -- Blossom of Amirdrassil
    [207172] = 132, -- Belor'relos, the Suncaller
    [207173] = 32,  -- Gift of Ursine Vengeance
    [207174] = 32,  -- Fyrakk's Tainted Rageheart
    [207175] = 195, -- Coiled Serpent Idol
    [207528] = 32,  -- Prophetic Stonescales
    [207552] = 20,  -- Echoing Tyrstone
    [207566] = 67,  -- Accelerating Sandglass
    [207579] = 132, -- Time-Thief's Gambit
    [208614] = 192, -- Augury of the Primal Flame
    [208615] = 132, -- Nymue's Unraveling Spindle
    [212449] = 67,  -- Sikran's Endless Arsenal
    ...
    [212684] = 132, -- Umbrelskul's Fractured Heart
    [212685] = 148, -- Tome of Unstable Power
    [212756] = 32,  -- Inexorable Resonator
    [212757] = 32,  -- Granyth's Enduring Scale
    [219294] = 194, -- Charged Stormrook Plume
    [219296] = 148, -- Entropic Skardyn Core
    [219297] = 32,  -- Cinderbrew Stein
    ...
    [219305] = 148, -- Carved Blazikon Wax
    [219306] = 20,  -- Burin of the Candle King
    [219309] = 32,  -- Tome of Light's Devotion
    [219310] = 20,  -- Bursting Lightshard
    [219311] = 97,  -- Void Pactstone
    [219312] = 214, -- Empowering Crystal of Anub'ikkaj
    [219313] = 148, -- Mereldar's Toll
    [219315] = 32,  -- Refracting Aggression Module
    [219316] = 32,  -- Ceaseless Swarmgland
    [219317] = 214, -- Harvester's Edict
    [219318] = 97,  -- Oppressive Orator's Larynx
    [219319] = 194, -- Twin Fang Instruments
    [219320] = 20,  -- Viscous Coaglam
    ...
    [231414] = 32,  -- Force of Will
    [231417] = 227, -- Hand of Justice
    [231420] = 20,  -- Second Wind
    [231424] = 148, -- Burst of Knowledge
    [231456] = 97,  -- Heart of Roccor
    [231457] = 20,  -- Bottled Magma
    [231462] = 32,  -- Molten Furnace
    [231471] = 227, -- Golem Gearbox
    [231476] = 132, -- Dope'rel's Calling Rune
    ...
    [242495] = 67,  -- Incorporeal Warpclaw
    [242497] = 148, -- Azhiccaran Parapodia
    [246344] = 67,  -- Cursed Stone Idol
    [249339] = 32,  -- Gloom-Spattered Dreadscale
    [249340] = 132, -- Wraps of Cosmic Madness
    [249341] = 20,  -- Volatile Void Suffuser
    [249342] = 97,  -- Heart of Ancient Hunger
    [249344] = 227, -- Light Company Guidon
    [249345] = 194, -- Ranger-Captain's Iridescent Insignia
    [249346] = 148, -- Vaelgor's Final Stare
    [249805] = 195, -- Undreamt God's Oozing Vestige
    [249806] = 227, -- Radiant Plume
    [249807] = 32,  -- The Eternal Egg
    [249808] = 20,  -- Litany of Lightblind Wrath
    [249809] = 148, -- Locus-Walker's Ribbon
    [249810] = 132, -- Shadow of the Empyrean Requiem
    [249811] = 20,  -- Light of the Cosmic Crescendo
    [250144] = 214, -- Emberwing Feather
    [250214] = 214, -- Lightspire Core
    [250215] = 214, -- Freightrunner's Flask
    [250223] = 132, -- Soulcatcher's Charm
    [250224] = 132, -- Mindpiercer's Sigil
    [250225] = 194, -- Void Execution Mandate
    [250226] = 67,  -- Latch's Crooked Hook
    [250227] = 67,  -- Kroluk's Warbanner
    [250228] = 227, -- Resonant Bellowstone
    [250229] = 97,  -- Idol of the War Loa
    [250238] = 97,  -- Seed of the Devouring Wild
    [250241] = 97,  -- Mark of Light
    [250242] = 32,  -- Jelly Replicator
    [250243] = 32,  -- Manaheart's Binding Flame
    [250244] = 32,  -- Permafrost Essence
    [250245] = 32,  -- Tumor of the Swarm
    [250246] = 20,  -- Refueling Orb
    [250248] = 20,  -- Mycolic Medicine
    [250253] = 20,  -- Whisper of the Duskwraith
    [250254] = 20,  -- Seed of Radiant Hope
    [250255] = 20,  -- Unstable Felheart Crystal
    [250257] = 198, -- Eye of the Drowning Void
    [250259] = 192, -- Sapling of the Dawnroot
    [260235] = 227, -- Umbral Plume
    [270160] = 32,  -- First Mate's Shellward
    [270161] = 132, -- Fang of Umbral Malignance
    [270162] = 20,  -- Soulcoiler Ritual Vessel
    [270163] = 97,  -- Sszorak's Ferocity
    [270165] = 227, -- Keeper's Seething Core
    [270166] = 194, -- Vashnik's Sanguine Rancor
    [270167] = 148, -- Wavecaller's Seastone
    [270168] = 192, -- Font of Venomous Rage
    [270169] = 148, -- Hex Lord's Dooming Idol
    [270170] = 132, -- Vexhul's Everflowing Gland
    [270171] = 20,  -- Preternatural Antivenom
    [270173] = 227, -- Zul'jin's Guillotine Technique
    [270174] = 32,  -- Idol of the Howling Nexus
    [270175] = 227, -- Voracious Heart of Ula'tek
    [273649] = 148, -- Stormbound Emblem of Dazar
    [273794] = 132, -- Knot of Writhing Serpents
    [273795] = 97,  -- Coiled Fangstone
    [273797] = 195, -- Tattered Amani War Banner
}