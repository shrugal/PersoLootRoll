...
L["OPT_SHOULD_CHAT_DESC"] = "Hier kannst du entscheiden wann da Addon in den Gruppen/Raid Chat postet und andere Spieler anschreibt."
...
L["OPT_CUSTOM_MESSAGES_DESC"] = "Passe die Nachrichten an, die das Addon anderen Spielern sendet. Zzt. können die Anzahl und Position von Platzhaltern (|cffffff00%s|r, |cffffff00%p|r) noch nicht geändert werden, d.h. du musst sicherstellen dass deine angepassten Nachrichten mit den Standard Nachrichten in dieser Hinsicht übereinstimmen (Weitere Details in den Tooltips)."
...
L["OPT_MASTERLOOTER_COUNCIL_DESC"] = "Lege fest wer in deime Rat sein soll, wenn du der Plündermeister bist. Spieler im Rat können darüber abstimmen, wer welche Beute bekommen soll."
