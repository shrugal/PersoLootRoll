...
L["OPT_MASTERLOOTER_NEED_ANSWERS_DESC"] = "Lege bis zu 9 eigene Antworten für das 'Bedarf' Gebot fest, in absteigender Priorität. Trenne mehrer Einträge mit Kommas.\n\nBeim Rollen erreichst du sie per Rechtsklick auf den 'Bedarf' Button."
L["OPT_MASTERLOOTER_GREED_ANSWERS"] = "Eigene 'Gier' Answorten"
L["OPT_MASTERLOOTER_GREED_ANSWERS_DESC"] = "Lege bis zu 9 eigene Antworten für das 'Gier' Gebot fest, in absteigender Priorität. Trenne mehrer Einträge mit Kommas.\n\nBeim Rollen erreichst du sie per Rechtsklick auf den 'Gier' Button."
