...
L["ROLL_START"] = "開始擲骰在%s 從%s。"
L["ROLL_STATUS_-1"] = "已取消"
L["ROLL_STATUS_0"] = "等待中"
L["ROLL_STATUS_1"] = "運作中"
L["ROLL_STATUS_2"] = "完成"
L["ROLL_TRADED"] = "已交易"
L["ROLL_WHISPER_SUPPRESSED"] = "來自%s競標%s -> %s / %s。"
L["ROLL_WINNER_MASTERLOOT"] = "%s已經贏得%s 從%s。"
...
L["FILTER_HIDDEN"] = "隱藏的"
L["FILTER_HIDDEN_DESC"] = "包含已取消、處理中、已放棄以及隱藏的擲骰。"
...
L["OPT_CUSTOM_MESSAGES_DESC"] = "佔位文字的數量與位置(|cffffff00%s|r, |cffffff00%d|r) 目前無法更改，因此請確認你的自訂行能與相關的預設行匹配(詳情請參閱工具提示)。"
...
L["OPT_MSG_ROLL_START"] = "通告新的擲骰"
L["OPT_MSG_ROLL_START_DESC"] = "%s：物品連結\n%d：擲骰數字"
L["OPT_MSG_ROLL_START_MASTERLOOT"] = "通告新的擲骰(作為拾取分配者)"
L["OPT_MSG_ROLL_START_MASTERLOOT_DESC"] = "%s：物品連結\n%s：物品擁有者\n%d：擲骰數字"
L["OPT_MSG_ROLL_WINNER"] = "通告擲骰贏家"
L["OPT_MSG_ROLL_WINNER_DESC"] = "%s：贏家\n%s：物品連結"
L["OPT_MSG_ROLL_WINNER_MASTERLOOT"] = "通告擲骰贏家(作為拾取分配者)"
L["OPT_MSG_ROLL_WINNER_MASTERLOOT_DESC"] = "%s：贏家\n%s：物品連結\n%s：物品擁有者\n%s：他/她"
L["OPT_MSG_ROLL_WINNER_WHISPER"] = "密語擲骰贏家"
L["OPT_MSG_ROLL_WINNER_WHISPER_DESC"] = "%s：物品連結"
L["OPT_MSG_ROLL_WINNER_WHISPER_MASTERLOOT"] = "密語擲骰贏家(作為拾取分配者)"
L["OPT_MSG_ROLL_WINNER_WHISPER_MASTERLOOT_DESC"] = "%s：物品連結\n%s：物品擁有者\n%s：他/她"
L["OPT_MSG_BID"] = "競標來自其他玩家的物品"
L["OPT_MSG_BID_DESC"] = "%s：物品連結"
L["OPT_MSG_ROLL_ANSWER_BID"] = "回答：競標已登記"
L["OPT_MSG_ROLL_ANSWER_BID_DESC"] = "%s：物品連結"
L["OPT_MSG_ROLL_ANSWER_YES"] = "回答：你可以得到它"
L["OPT_MSG_ROLL_ANSWER_YES_DESC"] = ""
L["OPT_MSG_ROLL_ANSWER_YES_MASTERLOOT"] = "回答：你可以得到它(作為拾取分配者)"
L["OPT_MSG_ROLL_ANSWER_YES_MASTERLOOT_DESC"] = "%s：物品擁有者"
L["OPT_MSG_ROLL_ANSWER_NO_SELF"] = "回答：我自己也需要"
L["OPT_MSG_ROLL_ANSWER_NO_SELF_DESC"] = ""
L["OPT_MSG_ROLL_ANSWER_NO_OTHER"] = "回答：我已經給了別人"
L["OPT_MSG_ROLL_ANSWER_NO_OTHER_DESC"] = ""
L["OPT_MSG_ROLL_ANSWER_NOT_TRADABLE"] = "回答：這無法交易"
...
L["OPT_MASTERLOOT_APPROVAL_DESC"] = "在此你可以決定誰可以成為你的拾取分配者。"
