...
L["ERROR_ROLL_BID_IMPOSSIBLE_SELF"] = "You cannot bid on that item right now." -- Translation missing
L["ERROR_ROLL_BID_IMPOSSIBLE_OTHER"] =  "%s has send a bid for %s but is not allowed to do so right now." -- Translation missing
L["ERROR_ROLL_VOTE_IMPOSSIBLE_SELF"] = "You cannot vote on that item right now." -- Translation missing
L["ERROR_ROLL_VOTE_IMPOSSIBLE_OTHER"] =  "%s has send a vote for %s but is not allowed to do so right now." -- Translation missing
