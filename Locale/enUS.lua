...
L["OPT_MASTERLOOTER_NEED_ANSWERS_DESC"] = "Specify up to 9 custom answers when rolling 'Need', with decreasing priority. Separate multiple entries with Commas.\n\nThey can be accessed by right-clicking on the 'Need' button when rolling on loot."
L["OPT_MASTERLOOTER_GREED_ANSWERS"] = "Custom 'Greed' answers"
L["OPT_MASTERLOOTER_GREED_ANSWERS_DESC"] = "Specify up to 9 custom answers when rolling 'Greed', with decreasing priority. Separate multiple entries with Commas.\n\nThey can be accessed by right-clicking on the 'Greed' button when rolling on loot."
