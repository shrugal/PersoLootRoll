...
L["OPT_ITEM_FILTER_ENABLE"] = "Enable additional conditions"
L["OPT_ITEM_FILTER_ENABLE_DESC"] = "By default just items you can't use or send to an alt will be filtered out. Here you can set additional conditions that items must fulfill in order to be shown to you."
...
L["OPT_COLLECTIONS"] = "Always show missing collectible items from these collections, regardless of the other conditions."
