...
L["TIP_MASTERLOOT_INFO"] = 
 ...
 .. "|cffffff00Run-time:|r %ds (+ %ds per item)\n"
...
L["OPT_ILVL_THRESHOLD_DESC"] = "Items must be a maximum of this much item-levels lower than what you have to be considered useful, double that for trinkets."
...
L["OPT_MASTERLOOTER_TIMEOUT_BASE"] = "Run-time (base)"
L["OPT_MASTERLOOTER_TIMEOUT_BASE_DESC"] = "The base run-time for rolls, regardless of how many items have dropped."
L["OPT_MASTERLOOTER_TIMEOUT_PER_ITEM"] = "Run-time (per item)"
L["OPT_MASTERLOOTER_TIMEOUT_PER_ITEM_DESC"] = "Will be added to the base run-time for each item that dropped."
