...
L["OPT_SHOULD_CHAT_DESC"] = "Define when the addon should post to group/raid chat and whisper other players."
...
L["OPT_CUSTOM_MESSAGES_DESC"] = "Customize the messages the addon sends to other players. The number and position of placeholders (|cffffff00%s|r, |cffffff00%d|r) cannot be changed currently, so make sure your custom lines match the default lines in this regard (see tooltips for details)."
...
L["OPT_ITEM_FILTER_DESC"] = "Customize the rules for declaring an item useful to you. You will only be asked to roll on useful items."
L["OPT_ILVL_THRESHOLD"] = "Item-level threshold"
L["OPT_ILVL_THRESHOLD_DESC"] = "Items can be at most this much item-levels lower than what you have to be considered useful, double that for trinkets."
L["OPT_ILVL_THRESHOLD_TRINKETS"] = "Double threshold for trinkets"
L["OPT_ILVL_THRESHOLD_TRINKETS_DESC"] = "Trinkets should have double the normal threshold because procc effects can make their value vary by a large amount."
