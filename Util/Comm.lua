...
Self.EVENTS = {Self.EVENT_CHECK, Self.EVENT_VERSION, Self.EVENT_STATE, Self.EVENT_SYNC, Self.EVENT_STATUS, Self.EVENT_NOTICE, Self.EVENT_BID, Self.EVENT_BID_WHISPER, Self.EVENT_VOTE, Self.EVENT_MASTERLOOT_ASK, Self.EVENT_MASTERLOOT_OFFER, Self.EVENT_MASTERLOOT_ACK, Self.EVENT_MASTERLOOT_DEC, Self.EVENT_XREALM}
...
function Self.RollBid(roll, bid, fromUnit, randomRoll, isImport, silent)
    ...
    if roll.isTest or isImport or not roll.uid then return end
